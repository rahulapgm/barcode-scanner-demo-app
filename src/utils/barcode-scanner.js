...
const wasmBinaryFile = '/barcode-scanner.wasm';
/*nif (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
}
...
var asmLibraryArg = {
  ...
  "fd_seek": _fd_seek,
  "fd_write": _fd_write,
  "js_output_result": _js_output_result,
...
/** @type {function(...*):?} */
var _scan_image = Module["_scan_image"] = createExportWrapper("scan_image");
